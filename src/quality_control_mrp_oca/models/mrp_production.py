...
class MrpProduction(models.Model):
    ...
    def _trigger_make_inspection(self,todo_moves,qc_trigger):
    ...
    def action_confirm(self):
        ...
        for r in self:
            qc_trigger = self.env.ref("quality_control_mrp_oca.qc_trigger_mrp_wo")
            r._trigger_make_inspection(r.workorder_ids.filtered(lambda x:not x.operation_id.outsourcing_product_id),qc_trigger)
        return res
